fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut result = result.iter().map(
        |(
            (a, (_, capacity1, durability1, flavor1, texture1, _)),
            (b, (_, capacity2, durability2, flavor2, texture2, _)),
            (c, (_, capacity3, durability3, flavor3, texture3, _)),
            (d, (_, capacity4, durability4, flavor4, texture4, _)),
        )| {
